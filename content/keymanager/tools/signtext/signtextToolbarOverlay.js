/* @(#) $Id: signtextToolbarOverlay.js,v 1.3 2012/01/26 02:49:41 subrata Exp $ */
...
avpki.keymanager.SignTextToolbarOverlay = {
    ...
    {
	if (!avpki.keymanager.SignTextToolbarOverlay.checkBinaryComponents()) {
	    return;
	}
	...
	*/
        ...
        var signTextWizardURL = "chrome://keymanager/content/tools/signtext/SignTextWizard.xul";
        window.openDialog(
		signTextWizardURL,
		'',
